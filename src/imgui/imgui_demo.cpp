...
// [SECTION] Example App: Simple Overlay / DebugGuiOverlay()
...
static void DebugGuiOverlay(bool* p_open);
...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (show_app_simple_overlay)      DebugGuiOverlay(&show_app_simple_overlay);
